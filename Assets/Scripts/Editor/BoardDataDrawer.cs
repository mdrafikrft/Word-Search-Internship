...
public class BoardDataDrawer : Editor
{
    ...
    {
        InitializeReorderableList(ref _dataList, "SearchWords", "Searching Word");
    }
    ...
    public void DrawColumnsRowsInputFields()
    {
    ...
    private void InitializeReorderableList(ref ReorderableList list, string propertyName, string listLabel)
    {
        ...
        list.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
        {
            ...
            EditorGUI.PropertyField(
                new Rect(rect.x, rect.y, EditorGUIUtility.labelWidth, 
    ...
    {
        if(GUILayout.Button("To UpperButton"))
        {
